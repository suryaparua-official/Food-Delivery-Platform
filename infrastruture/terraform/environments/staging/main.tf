...
module "ec2" {
  ...
  master_node_count        = var.staging_master_node_count
  worker_node_count        = var.staging_worker_node_count
  master_instance_type     = var.staging_master_instance_type
  worker_instance_type     = var.staging_worker_instance_type
...
module "rds" {
  ...
  allocated_storage         = var.staging_db_allocated_storage
  instance_class            = var.staging_db_instance_class
  postgres_version          = var.postgres_version
  database_name             = var.database_name
  db_username               = var.db_username
  db_password               = var.db_password
  backup_retention_period   = var.staging_backup_retention_period
  multi_az                  = var.staging_multi_az
...
module "elasticache" {
  ...
  num_cache_nodes           = var.staging_redis_num_cache_nodes
  automatic_failover_enabled = var.staging_redis_automatic_failover
