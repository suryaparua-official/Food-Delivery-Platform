...
const Home = () => {
  ...
  // ✅ Added delivery time calculation (no other change)
  const getEstimatedTime = (distanceKm: number): string => {
    ...
    const totalTime = Math.round(travelTimeMinutes + prepTimeMinutes);
      ...
      {restaurants.length > 0 ? (
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {restaurants.map((res) => {
            ...
            const deliveryTime = getEstimatedTime(distance);
